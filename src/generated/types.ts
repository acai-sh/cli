...
export type FeatureContextAcidEntry = import("./openapi.ts").components["schemas"]["FeatureContextResponse"]["data"]["acids"][number];
export type FeatureContextResponse = import("./openapi.ts").components["schemas"]["FeatureContextResponse"];
export type FeatureStatesRequest = import("./openapi.ts").components["schemas"]["FeatureStatesRequest"];
export type FeatureStatesResponse = import("./openapi.ts").components["schemas"]["FeatureStatesResponse"];
